...
// import Page from '../bookelements/page'
...
// The HTML for a Book.
function Book({pages, setPages}: BookProps) {
    return (
        <div className="book">
            {pages.map((page) => (
...
function LogModal({ display, setDisplay }: ModalProps, { pages, setPages }: BookProps) {
    ...
    return (
        <div>
            ...
            <div id="profile-page">
                ...
                <LogModal display={modalDisplay} setDisplay={setModalDisplay} pages={pages} setPages={setPages}></LogModal>
            </div>
